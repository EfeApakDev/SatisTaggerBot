...
async def start(event):
  await event.reply("**🌀ResatinTaggerBotu**\n ile Grubunuzdakı Nerdeyse Tüm Üyelere Etiket Ata bilirim \nKomutlar için =======> /help yazın**",
                    buttons=(
                   
		      [Button.url('Beni Gruba Ekle ➕', 'https://t.me/sancakbotagger191881bot?startgroup=a')],
                      [Button.url('Support🛠', 'https://t.me/sancakbegi')],
                      [Button.url('Resmi Kanal📣', 'https://t.me/sancakbegi')],
		      [Button.url('Developer👨🏻‍💻', 'https://t.me/sancakbegi')],
                    ),
                    link_preview=False
                   )
@client.on(events.NewMessage(pattern="^/help$"))
async def help(event):
  helptext = "**🌀 resatin TaggerBot Komutları**\n\n**/tag <sebeb> - 5-li Etiket Atar**\n\n**/etag <sebeb> - Emoji ile etiketler**\n\n**/tektag sebeb - Üyeleri Tek Tek Etiketler**\n\n**/admins sebeb - Yöneticileri Tek Tek Tag Eder**\n\n**/start - botu başlatır**"
...
async def help(event):
  helptext = "**Çok özellikleri Etiket Botu Bulmaya Çalışan Grub Sahibleri bu bot Size Göre:\n\n📌 5-li etiket\n📌 Emoji etiket\n📌 Tekli Etiket\n📌 Yalnız Yöneticileri etiketleme\n📌\n\n Böyle Çok özellikli Bot 'u grubunuza yönetici olarak ekleyip rahatlıkla üyelir , etiket ata bilirsiz **"
  await event.reply(helptext,
                    buttons=(
                      [Button.url('Botu Gruba Ekle➕', 'https://t.me/sancakbotagger191881bot?startgroup=a')],
                    ),
                    link_preview=False
                   )
...
print(">> Bot çalısiyor merak etme 🚀 @sancakbegi bilgi alabilirsin <<")
